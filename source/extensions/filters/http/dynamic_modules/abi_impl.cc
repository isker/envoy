...
envoy_dynamic_module_callback_metric_counter_new(
  ...
  // TODO I cargo culted this from wasm context.cc, is this really the right
  // gymnastics to be doing?
...
envoy_dynamic_module_callback_metric_gauge_new(
  ...
  Stats::Gauge* c = &Stats::Utility::gaugeFromStatNames(
      filter_config->stats_scope_, {filter_config->custom_stat_namespace_, stat_name}, Stats::Gauge::ImportMode::Accumulate);
  return c;
}
